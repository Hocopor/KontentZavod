...
- [ ] `[S]` Качество RU-озвучки: ревизия доступных edge-tts голосов (ru-RU-*, мультиязычные нейроголоса), настройка rate/pitch, выбор лучшего по умолчанию; прослушка в панели запуска уже есть.
